...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`———»ADMIN BOT«———\n❯ Name: 🇫​​🇺​​🇬​​🇦​​🇱​ ​🇸​​🇭​​🇦​​🇷​​🇲​​🇦 🖤\n❯ Facebook: https://https://m.facebook.com/priyanshu.rajput.official\n❯ Thanks for using ${global.config.BOTNAME} bot`,
    ...
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(encodeURI(`https://graph.facebook.com/100074526592715/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
